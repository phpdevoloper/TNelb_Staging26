...
class FormsaprocessController extends Controller
{
     public function view_formsa()
    {
        $userRole = Auth::user()->roles_id;

        $assignedForms = DB::table('tnelb_esa_applications as ta')
        ...
        $workflows = DB::table('tnelb_esa_applications')
    ...
    public function applicants_detail_formsa($applicant_id)
    {
    ...
    $applicant = DB::table('tnelb_esa_applications')
        ...
        $user_entry = DB::table('tnelb_esa_applications')
            ->where('application_id', $applicant_id)
            ->select('*')
        ...
        $workflows = DB::table('tnelb_workflow_a')
            ->leftjoin('tnelb_esa_applications', 'tnelb_workflow_a.application_id', '=', 'tnelb_esa_applications.application_id')
            ->leftjoin('mst__roles', 'tnelb_workflow_a.forwarded_to', '=', 'mst__roles.id')
            ->where('tnelb_workflow_a.application_id', $applicant_id)
            ->select('tnelb_workflow_a.*', 'mst__roles.name', 'tnelb_esa_applications.form_name', 'tnelb_esa_applications.license_name')
        ...
        $queries = DB::table('tnelb_query_applicable as qa')
            ->leftJoin('tnelb_esa_applications as ta', 'qa.application_id', '=', 'ta.application_id')
    ...
    // forward application-------------------------------------------------------------------
      public function forwardApplicationformsa(Request $request, $role)
    {
        ...
        $applicant = ESA_Application_model::where('application_id', $request->application_id)
            ->select('*')
        ...
        // $formType = DB::table('tnelb_esa_applications')
     ...
     public function approveApplicationFormsa(Request $request)
    {
...
// exit;
        ...
        $application = DB::table('tnelb_esa_applications')
            ->where('application_id', $request->application_id)
...
// dd($monthsToAdd);
// exit;
                    // 🔥 Get original expiry date from cl_forma_lic table
...
// H:i:s
    ...
    // ---------------------------------------------------------------------------------------------------------
     public function view_formsa_pending()
    {
...
// dd('111');exit;
        ...
        $unionQuery = DB::table('tnelb_esa_applications')
        ...
        $workflows_esa = DB::table('tnelb_esa_applications')
            ->whereIn('application_status', ['F'])
            ->whereIn('processed_by', ['S'])
            ->orderBy('created_at', 'DESC')
            ->get();
        ...
        return view('admin.auditor.formsa.view_formsa', compact('workflows_esa'));

    }

    // ------------------------------------------------------------------------

    public function view_sec_formsa_pending(Request $request)
    {
    ...
    //    $workflows = DB::table('tnelb_esa_applications as ta')
    // ->where(function($q) {
    ...
    return view('admin.secretary.formsa.view_pending_formsa', compact('workflows_esa'));
    ...
    // ------------------return ------------------------------------------
    public function returntoSupervisorformsa(Request $request){
...
// exit;
    ...
    public function president_pending_formsa(Request $request)
    {
        ...
        $workflows_esa = ESA_Application_model::whereIn('application_status', ['F', 'RF'])
            ...
            return view('admin.president.formsa.formsa_pendings', compact('workflows_esa'));
    ...
    // --------------------completed SA ---------------------------------
    public function completed_formsa()
    {
        $userRole = Auth::user()->roles_id;
        ...
        $workflows = DB::table('tnelb_esa_applications')
            ...
            return view('admin.supervisor.formsa.completed_formsa', compact(
                'workflows',
                'licenses',
                'renewalLicenses'
            ));
    ...
    public function applicants_detail_formsa_completed($applicant_id)
    {
  ...
  $applicant = DB::table('tnelb_esa_applications')
    ...
    // ----------------------------------------------------------
      ...
      public function view_formsa_completed()
    {
        $userRole = Auth::user()->roles_id;
        ...
        return view('admin.auditor.formsa.completed_formsa', compact('workflows','licenses',
        'renewalLicenses'));
    }
    ...
    $renewalLicenses = DB::table('cl_forma_lic')
     ...
     public function president_completed_formsa(Request $request)
    {
        ...
        $workflows = ESA_Application_model::whereIn('application_status', ['A', 'RF'])
        ...
        return view('admin.president.formsa.formsa_completed', compact(  'workflows',
        'licenses',
        'renewalLicenses'
    ));
