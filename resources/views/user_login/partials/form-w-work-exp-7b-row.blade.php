{{-- Form W §7b only: board-member work row. Mirrors Form S §7b but without Voltage / Nature / Transformer hidden fields. --}}
@php
...
<div class="work-fields work-row{{ $storedRowClass }}" data-row-index="{{ $rowIndex }}">
    ...
    {{-- Keep parallel [] indexes for the fields §7a rows post; unused in §7b UI. --}}
