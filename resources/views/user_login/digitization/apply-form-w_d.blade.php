...
<style>
    ...
    .fs-breadcrumb-bar #breadcrumb {
        ...
        list-style: none !important; margin: 0 !important; padding: 0 !important; font-size: 0.85rem; background: none !important;
    }
    ...
    #work-table .form-s-actions-stack { display: flex; flex-direction: column; align-items: center; justify-content: flex-start; gap: .35rem; }
    ...
    #work-table .work-exp-col-company { width: 28%; }
    #work-table .work-exp-col-years { width: 38%; min-width: 17rem; }
    #work-table .work-exp-col-designation { width: 20%; }
    #work-table td.work-exp-col-actions { vertical-align: middle; width: 2.75rem; white-space: nowrap; }
        ...
        <div class="fs-card comp_certificate" data-select2-id="14">
            ...
            <div class="fs-card-header">
                ...
                <div class="instructions-link">
                    ...
                    <a href="{{url('assets/pdf/form_w_notes.pdf')}}" target="_blank">தமிழ் <i class="fa fa-file-pdf-o"></i> (38 KB)</a>
                </div>
            </div>
                ...
                <form id="competency_form_ws" enctype="multipart/form-data">
                    ...
                    <div class="fs-section">
                        <div class="fs-section-header">
                            ...
                            <div>
                                <div class="fs-section-title">Details of Previous and Current Work experiences</div>
                                <div class="fs-section-tamil">பெற்றுள்ள முந்தைய மற்றும் தற்போதைய அனுபவங்களின் விவரங்கள்</div>
                            </div>
                        </div>
                        <div class="fs-section-body">
                    ...
                    <div class="fs-section">
                        <div class="fs-section-header">
                            ...
                            <div>
                                <div class="fs-section-title">Have you applied for and obtained a Certificate of Qualification for Wireman / Wireman Helper? If yes, please state its number and validity.</div>
                                <div class="fs-section-tamil">இதற்கு முன்னாள் விண்ணப்பம் செய்து மின்கம்பியாளர் தகுதி சான்றிதழ் / மின் கம்பி உதவியாளர் தகுதி சான்றிதழ் பெறப்பட்டுள்ளதா? ஆம் என்றால் அதன் எண் மற்றும் செல்லத்தக்க காலம் குறிப்பிடுக</div>
                            </div>
                        </div>
                        <div class="fs-section-body">
                            @php
                            ...
                            <div id="previously_details" class="fs-toggle-panel" style="display:{{ $hasOldPrefill ? 'block' : 'none' }};">
                                <div class="row g-2 align-items-end">
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input autocomplete="off" class="form-control verify-issue-date" id="previously_issue_date" name="certificate_issue_date" type="date" data-error="#previouslyIssueDateError" value="">
    ...
    <div class="prv-panel">
        <div class="prv-header">
            <div class="prv-header-left">
                <h5><i class="fa fa-file-text-o"></i> Application Preview <span class="prv-badge">FORM - W / Certificate B</span></h5>
        ...
        <div class="prv-body" id="prvBody">
            ...
            <div class="prv-section">
                <div class="prv-section-hd"><span class="prv-section-num">8</span><span class="prv-section-title">Previously Obtained Wireman / Wireman Helper Certificate</span></div>
                <div class="prv-section-body">
            ...
            <div class="prv-section">
                <div class="prv-section-hd"><span class="prv-section-num">9</span><span class="prv-section-title">Identity &amp; Uploaded Documents</span></div>
                <div class="prv-section-body">
...
<td class="form-s-actions-cell text-center p-1"><div class="form-s-actions-stack"><button type="button" class="btn-tbl-remove remove-education py-1 px-2" title="Remove row"><i class="fa fa-trash-o"></i></button></div></td>`;
    ...
    function populatePreview(){
        ...
        setValW('prv_fathers_name',(document.getElementById('Fathers_Name')||{}).value||'');
        setValW('prv_address',(document.getElementById('applicants_address')||{}).value||'');
        setValW('prv_dob',(document.getElementById('d_o_b')||{}).value||'');
        setValW('prv_age',(document.getElementById('age')||{}).value||'');
        setValW('prv_email',(document.getElementById('applicant_email')||{}).value||'');
        // Education
        ...
        // Work Experience (7a / 7b) — mirrors Form S engine, minus Nature/Voltage/Transformer
        ...
        if(isY){
            setValW('prv_cert_no',(document.getElementById('previously_number')||{}).value||'');
            setValW('prv_cert_issue_date',fmtDateW((document.getElementById('previously_issue_date')||{}).value||''));
            setValW('prv_cert_expiry_date',fmtDateW((document.getElementById('previously_date')||{}).value||''));
        }
        // Photo & Sign
        ...
        // Aadhaar & PAN
        setValW('prv_aadhaar',(document.getElementById('aadhaar')||{}).value||'');
        setValW('prv_pan',(document.getElementById('pancard')||{}).value||'');
        setValW('prv_aadhaar_doc',fileLabelW(document.getElementById('aadhaar_doc')));
