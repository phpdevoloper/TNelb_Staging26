...
<style>
    ...
    /* ── Work-table specific (13-column SCC layout) ──── */
    #work-table.work-exp-table { font-size: .78rem; width: 100%; min-width: 108rem; max-width: 100%; }
    #work-table.work-exp-table thead th { font-size: .7rem; font-weight: 600; padding: .3rem .35rem; vertical-align: middle; line-height: 1.2; text-align: center; }
    #work-table.work-exp-table tbody td { padding: .35rem .35rem; vertical-align: top; }
    #work-table .form-control { font-size: .76rem; padding: .2rem .35rem; line-height: 1.25; }
    #work-table select.form-control { padding-right: 1.1rem; }
    /* Column widths */
    #work-table .work-exp-col-sno         { width: 2.4rem;  min-width: 2.4rem;  text-align: center; }
    #work-table .work-exp-col-type        { width: 8rem;    min-width: 8rem; }
    #work-table .work-exp-col-cat         { width: 5.5rem;  min-width: 5.5rem; }
    #work-table .work-exp-col-licence     { width: 6.5rem;  min-width: 6.5rem; }
    #work-table .work-exp-col-employer    { width: 10rem;   min-width: 10rem; }
    #work-table .work-exp-col-address     { width: 10rem;   min-width: 10rem; }
    #work-table .work-exp-col-designation { width: 7rem;    min-width: 7rem; }
    #work-table .work-exp-col-nature      { width: 8rem;    min-width: 8rem; }
    #work-table .work-exp-col-voltage     { width: 8rem;    min-width: 8rem; }
    #work-table .work-exp-col-kva         { width: 5.5rem;  min-width: 5.5rem; }
    #work-table .work-exp-col-years       { width: 22rem;   min-width: 22rem; }
    #work-table .work-exp-col-upload      { width: 8rem;    min-width: 8rem; }
    #work-table .work-exp-col-relieve     { width: 8rem;    min-width: 8rem; }
    #work-table .work-exp-col-actions     { width: 2.5rem;  min-width: 2.5rem; white-space: nowrap; }
    /* Disabled / locked visual cue (still keeps fields posting where applicable) */
    #work-table .form-control:disabled,
    #work-table .form-control[readonly]:not(.work-duration-y):not(.work-duration-m):not(.work-duration-d),
    #work-table input:disabled { background: #f1f3f5; color: #6c757d; cursor: not-allowed; }
    #work-table input[type="file"].is-locked { background: #f1f3f5; pointer-events: none; opacity: .55; }
    /* Period of Experience composite header (Date / Periods) */
    #work-table thead th.work-exp-col-years { vertical-align: top; padding-bottom: 0; }
    #work-table .work-exp-period-head { display: flex; flex-direction: column; }
    #work-table .work-exp-period-head-top { font-weight: 600; font-size: .72rem; padding: .15rem .25rem; }
    #work-table .work-exp-period-head-row { display: flex; align-items: stretch; border-top: 1px solid #dee2e6; }
    #work-table .work-exp-period-head-row > .work-exp-period-head-band {
        flex: 1 1 0; display: flex; flex-direction: column; min-width: 0;
    }
    #work-table .work-exp-period-head-row > .work-exp-period-head-band + .work-exp-period-head-band { border-left: 1px solid #dee2e6; }
    #work-table .work-exp-period-head-band-title {
        font-weight: 600; font-size: .68rem; color: #212529;
        padding: .15rem .25rem; line-height: 1.15;
    }
    #work-table .work-exp-period-head-band-sub { display: flex; border-top: 1px solid #dee2e6; }
    #work-table .work-exp-period-head-band-sub > span {
        flex: 1 1 0; text-align: center;
        font-size: .65rem; font-weight: 600; color: #495057;
        padding: .1rem .15rem; line-height: 1.15; min-width: 0;
    }
    #work-table .work-exp-period-head-band-sub > span + span { border-left: 1px solid #dee2e6; }
    /* Period of Experience body cell */
    #work-table .work-exp-inline { display: flex; flex-wrap: nowrap; gap: .25rem; align-items: flex-start; }
    #work-table .work-exp-date-group { flex: 1 1 0; min-width: 6.25rem; display: flex; flex-direction: column; gap: .15rem; }
    #work-table .work-exp-till-toggle {
        display: flex; align-items: center; gap: .2rem;
        font-size: .65rem; color: #495057; margin: 0; user-select: none;
    }
    #work-table .work-exp-till-toggle input { transform: scale(.9); margin: 0; }
    #work-table .work-exp-total-inline { flex: 0 0 6.5rem; min-width: 6.5rem; }
    #work-table .work-date-from,
    #work-table .work-date-to { font-size: .72rem; color: #212529; width: 100%; min-width: 0; }
    #work-table .work-duration-ymd { display: flex; gap: .15rem; align-items: flex-end; justify-content: center; width: 100%; }
    ...
    #work-table .work-duration-label {
        ...
        color: #6c757d; line-height: 1; margin-bottom: .08rem;
    }
    #work-table .work-duration-y,
    #work-table .work-duration-m,
    #work-table .work-duration-d {
        font-size: .65rem; padding: .15rem .04rem; line-height: 1.2;
        text-align: center; width: 100%; min-width: 0; background: #fff;
    }
    /* Upload cells */
    #work-table .work-exp-upload-head { font-size: .68rem; line-height: 1.15; font-weight: 600; }
    #work-table .work-exp-upload-head .file-limit { font-size: .6rem; font-weight: 500; }
    #work-table td.work-exp-col-actions { vertical-align: middle; text-align: center; }
    #work-table .form-s-file-upload-wrap--combined { min-width: 7rem; }
    /* Shrink the file pill so it fits the new narrower upload columns */
    #work-table .form-s-file-upload-wrap--combined .form-control,
    #work-table .form-s-file-upload-wrap--combined input[type="file"] { font-size: .68rem; padding: .25rem .3rem; }
                                ...
                                <table class="table table-bordered table-sm work-exp-table" id="work-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="work-exp-col-type">Employment Type<br><small>(dropdown)</small></th>
                                            <th class="work-exp-col-cat">Contractor Category<br><small>(dropdown)</small></th>
                                            <th class="work-exp-col-licence">Licence Number</th>
                                            <th class="work-exp-col-employer">Name of Contractor / organization / Board of Apprenticeship</th>
                                            <th class="work-exp-col-address">Organisation Address</th>
                                            <th class="work-exp-col-designation">Designation</th>
                                            <th class="work-exp-col-nature">Nature of Work Experience<br><small>(dropdown)</small></th>
                                            <th class="work-exp-col-voltage">Voltage Level<br><small>(dropdown)</small></th>
                                            <th class="work-exp-col-kva">Highest Transformer capacity in kVA</th>
                                            <th class="work-exp-col-years" scope="col">
                                                <div class="work-exp-period-head">
                                                    <div class="work-exp-period-head-top">Period of Experience</div>
                                                    <div class="work-exp-period-head-row">
                                                        <div class="work-exp-period-head-band">
                                                            <div class="work-exp-period-head-band-title">Date</div>
                                                            <div class="work-exp-period-head-band-sub">
                                                                <span>From</span><span>To</span>
                                                            </div>
                                                        </div>
                                                        <div class="work-exp-period-head-band">
                                                            <div class="work-exp-period-head-band-title">Periods <small style="font-weight:500;">(auto)</small></div>
                                                            <div class="work-exp-period-head-band-sub">
                                                                <span>YY</span><span>MM</span><span>days</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </th>
                                            <th class="work-exp-col-upload work-exp-upload-head">Upload Supporting documents<br><span class="file-limit">File type: PDF (Min 5 KB To Max 200 KB)</span></th>
                                            <th class="work-exp-col-relieve work-exp-upload-head">Upload Relieving Letter<br><span class="file-limit">File type: PDF (Min 5 KB To Max 200 KB)</span></th>
                                    ...
                                    <tbody id="work-container">
                                        <tr class="work-fields">
                                            ...
                                            <td class="work-exp-col-cat">
                                                <select class="form-control form-control-sm work-contractor-cat" name="work_contractor_category[]" disabled>
                                                    <option value="">—</option>
                                            ...
                                            <td class="work-exp-col-licence">
                                                <input type="text" class="form-control form-control-sm work-licence-number" name="work_licence_number[]" maxlength="40" autocomplete="off" disabled>
                                            </td>
                                            <td class="work-exp-col-employer">
                                            ...
                                            <td class="work-exp-col-address">
                                                <input type="text" class="form-control form-control-sm work-org-address" name="work_organisation_address[]" maxlength="255" autocomplete="off" disabled>
                                            </td>
                                            <td class="work-exp-col-designation">
                                                <input type="text" class="form-control form-control-sm work-designation" name="designation[]" maxlength="80" autocomplete="off" disabled>
                                            </td>
                                            <td class="work-exp-col-nature">
                                                <select class="form-control form-control-sm work-nature" name="work_nature_of_work[]" disabled>
                                                    <option value="">—</option>
                                            ...
                                            <td class="work-exp-col-voltage">
                                                <select class="form-control form-control-sm work-voltage" name="work_voltage_level[]" disabled>
                                                    <option value="">—</option>
                                            ...
                                            <td class="work-exp-col-kva">
                                                <input type="number" class="form-control form-control-sm work-transformer-kva" name="work_transformer_kva[]" min="0" max="9999999" step="any" inputmode="decimal" autocomplete="off" disabled>
                                            </td>
                                            <td class="work-exp-col-years">
                                                <div class="work-exp-inline">
                                                    <div class="work-exp-date-group">
                                                        <input type="date" class="form-control form-control-sm work-date-from" name="work_date_from[]" title="From date" aria-label="Period of experience: from date" disabled>
                                                    </div>
                                                    <div class="work-exp-date-group">
                                                        <input type="date" class="form-control form-control-sm work-date-to" name="work_date_to[]" title="To date" aria-label="Period of experience: to date" disabled>
                                                        <label class="work-exp-till-toggle">
                                                            <input type="checkbox" class="work-date-till" tabindex="-1">
                                                            <span>Till date</span>
                                                        </label>
                                            ...
                                            <td class="work-exp-col-upload">
                                                <div class="form-s-file-upload-wrap form-s-file-upload-wrap--combined" data-upload-kind="work">
                                                    <input class="form-control form-control-sm p-1 work-doc-input" name="work_document[]" type="file" accept=".pdf,application/pdf,.jpg,.jpeg,.png,image/jpeg,image/png" disabled>
                                                </div>
                                            </td>
                                            <td class="work-exp-col-relieve">
                                                <div class="form-s-file-upload-wrap form-s-file-upload-wrap--combined" data-upload-kind="work">
                                                    <input class="form-control form-control-sm p-1 work-relieve-input" name="work_relieving_letter[]" type="file" accept=".pdf,application/pdf,.jpg,.jpeg,.png,image/jpeg,image/png" disabled>
                                                </div>
                                            </td>
...
<td class="form-s-actions-cell text-center p-1"><div class="form-s-actions-stack"><button type="button" class="btn-tbl-remove remove-education py-1 px-2" title="Remove row"><i class="fa fa-trash-o"></i></button></div></td>`;
    ...
    <script>
        /*
         * Section 7 – Work Experience (Form S, 13-column SCC layout).
         *
        ...
        (function() {
            ...
            function effectiveToStr($tr) {
                ...
                return ($tr.find('.work-date-to').val() || '').trim();
            }
            ...
            $(document).on('change', '#work-container .work-date-till', function() {
                var $tr = $workRow(this);
                applyTillDate($tr);
                if (!$tr.find('.work-date-to').prop('disabled')) {
                    $tr.find('.work-date-to').prop('required', true);
                }
                updateTotalYears($tr);
            });
            ...
            $(document).on('input change', '#work-container .work-employer-input', function() { syncLegacyHidden($workRow(this)); });
