...
<section class="">
    <div class="auto-container_a">
        <ul id="breadcrumb">
            ...
            <li><a href="#"> Renewal Application</a></li>
...
<section class="tabs-section apply-card">
    <div class="auto-container_a">
        <div class="apply-card-header bg-form" >
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h5 class="card-title_apply text-white text-center text-uppercase"> <span style="font-weight: 600;">Renewal Application for Electrical Contractor's Licence-Grade 'A' </span></h5>
        ...
        <form id="competency_form_a" enctype="multipart/form-data"
            data-submit-url="{{ route('forma.storerenewal') }}">
            ...
            <input type="hidden" class="form-control text-box single-line" id="license_number" name="license_number"
                value="{{ $old_license_number->license_number ?? $application->license_number }}">
