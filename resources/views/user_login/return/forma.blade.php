...
<section class="tabs-section apply-card">
    <div class="auto-container_a">
        <div class="apply-card-header bg-form">
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h5 class="card-title_apply text-white text-center text-uppercase"> <span style="font-weight: 600;">Return Application Details for Electrical Contractor's Licence-Grade 'A' </span></h5>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 text-md-right">
                    <a href="{{url('assets/pdf/form_a_notes.pdf')}}" class="text-white" target="_blank">
                        ...
                        English <i class="fa fa-file-pdf-o" style="color:red;"></i> (74 KB)</a>
        ...
        <form id="competency_form_a_return" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 border_return" >
                                <div class="border_return2">
                                    <span class="fw-semibold" >REMARKS :</span>
                                        <span>{{ $application->remarks_return }}</span>
                                 </div>
                            </div>
            ...
            <div id="director-section" class="mt-3" style="display: none;">
                ...
                <div class="tab" data-name="Staff & Bank Details">
                   ...
                   <div class="row form-section" id="qc_staff">
    ...
    <table class="table table-bordered" id="qc-staff-table">
        ...
        <thead>
            <tr>
                ...
                <th width="15%">
                    Attachments <span class="text-red">*</span>
                </th>
        ...
        @if(!$application)
            ...
            <tbody id="staffqc-records">
                ...
                {{-- New QC/QSC rows will be added by JavaScript --}}
        ...
        @else
            ...
            {{-- DRAFT / EXISTING APPLICATION --}}

            <input type="hidden"
                id="appl_type"
                name="appl_type"
                value="{{ $application->appl_type ?? 'D' }}">

            <tbody id="staffqc-records">

                @php
                    $qcStaffs = collect($QCstaffs ?? [])->values();

                    $staff_count = $qcStaffs->count();
                @endphp


                {{-- EXISTING QC/QSC STAFF --}}
                ...
                @for ($i = 0; $i < $staff_count; $i++)
                    ...
                    <tr class="staffqc-record"
                        data-id="{{ $staff->id }}"
                        data-row-index="{{ $staff->row_index }}">
                        ...
                        <td>
                            ...
                            <input type="hidden"
                                ...
                                value="{{ $staff->staff_category }}">

                            <input type="hidden"
                                name="staff_cc_no[]"
                                value="{{ $staff->staff_cc_no }}">
                        ...
                        <td>
                            ...
                            <input type="text"
                                ...
                                value="{{ $staff->staff_cc_first_issue }}"
                                readonly>
                        ...
                        <td>
                            ...
                            <input type="text"
                                ...
                                value="{{ $staff->staff_cc_validity_from }}"
                                readonly>
                        ...
                        <td>
                            ...
                            <input type="text"
                                ...
                                value="{{ $staff->staff_cc_validity_to }}">
                ...
                {{-- IMPORTANT:
                     DO NOT PUT FEE ROW HERE.
                     JavaScript will create it as the LAST row.
                --}}
                        ...
                        <tbody id="staff-container">
                            ...
                            @for($i = 0; $i < $staff_count; $i++)
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        class="btn btn-success addotherstaffs"
...
<tbody id="staff-container">
    ...
    <td>
        ...
        <input type="hidden"
               name="row_index[{{ $i }}]"
               value="{{ $staff->row_index ?? $rowIndex }}"
               class="form-control row_index">
    </td>
    ...
    <td class="cc-column"
        ...
        <input type="text"
               ...
               maxlength="15"
               placeholder="Certificate No"
               value="{{ old('cc_number.' . $i, $staff->staff_cc_no ?? '') }}"
               oninput="this.value=this.value.replace(/[^A-Za-z0-9]/g,'').toUpperCase()">
        ...
        <input type="date"
               ...
               value="{{ old(
                   ...
                   isset($staff->staff_cc_first_issue)
                       ? \Carbon\Carbon::parse($staff->staff_cc_first_issue)->format('Y-m-d')
                       : ''
               ) }}">
        ...
        <input type="date"
               ...
               value="{{ old(
                   ...
                   isset($staff->staff_cc_validity_from)
                       ? \Carbon\Carbon::parse($staff->staff_cc_validity_from)->format('Y-m-d')
                       : ''
               ) }}">
        ...
        <input type="date"
               ...
               value="{{ old(
                   ...
                   isset($staff->staff_cc_validity_to)
                       ? \Carbon\Carbon::parse($staff->staff_cc_validity_to)->format('Y-m-d')
                       : ''
               ) }}">
    ...
    <td class="action-column">
        ...
        @if ($i >= 2)
            ...
            <button type="button"
                    class="btn btn-danger removeStaffRow"
    ...
    @endfor
                    ...
                    <div class="row ">
                        <div class="col-md-12  ">
                            <div class="row align-items-center head_label " id="bank_solvency">
                                <div class="col-12 col-md-12 title_bar">
                            ...
                            <div class="row form-section" id="bank_solvency">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-12 col-md-12">
                                        ...
                                        <div class="col-12 col-md-12" id="bank_doc_section">
                                            <div class="row">
                                             ...
                                             <div class="col-md-12 mt-3 col-12 {{ empty($banksolvency->bank_doc) ? 'd-none' : '' }} file-link">
                                                            ...
                                                            <a href="{{ asset( $banksolvency->bank_doc) }}" target="_blank" class="text-primary fw-bold">
                                                                <i class="fa fa-file-pdf-o" style="color:red;"></i> View Document
                                                            </a>
                                                            @endif
                                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row border-right-12">
                            ...
                            <div class="row mt-2 form-section" id="address_proof">
                                <div class="col-12 col-md-3">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-5 ">
                                            <label for="Name">(i) Type of Address Proof <span style="color: red;">*</span>
                                            </label>
                            ...
                            <!-- -------------------------------------------- -->
                                <div class="col-12 col-md-4">
                                    <div class="row align-items-center">
                                        <div class="col-12 col-md-5 ">
                                            <label for="Name">(ii) GST/ Rental Aggrement/Others No: <span style="color: red;">*</span>
                                            </label>
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <span class="error text-danger" id="gst_doc_error"></span>
                                             ...
                                             <div class="col-md-12 mt-3 col-12 {{ empty($Address_proof->file_doc) ? 'd-none' : '' }} file-link">
                                                            ...
                                                            <a href="{{ asset( $Address_proof->file_doc) }}" target="_blank" class="text-primary fw-bold">
                                                                <i class="fa fa-file-pdf-o" style="color:red;"></i> View Document
                                                            </a>
                                                            @endif
                                            </div>
                ...
                <div class="tab form-section" id="equipments_details" data-name="Equipment / Instruments List ">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row align-items-center head_label">
                                <div class="col-12 col-md-12 title_bar">
                                                ...
                                                <div class="row g-1 align-items-start">
                                                    <div class="col-md-9">
                                                        ...
                                                        <span class="error text-danger"
                                                            ...
                                                            <span class="error text-danger instrument_test_report_error"></span>
                                                ...
                                                <div class="row g-1 align-items-start">
                                                    <div class="col-md-9">
                                                        ...
                                                        <span class="error text-danger"
                                                            ...
                                                            <span class="error text-danger instrument_purchase_report_error"></span>
                    ...
                    <div class="row enclosures">
                        ...
                        <div class="col-12 col-md-12 ">
                            ...
                            <ul>
                                ...
                                <li>7. Bank Solvency Certificate of Rs.50,000/- in Form ‘G’ (valid for a Maximum of three years).</li>
                            </ul>
                        </div>
                    </div>
...
let proprietorCount = initialDraftCount || 0;
    ...
    $rows.slice(0, 2).each(function() {
        ...
        if (!ccNumber || !firstIssue || !validityFrom || !validityTo) {
            allFilled = false;
            return false;
        }
    });
    ...
    let category = $lastRow.find('.staff_category').val();
    let designation = $lastRow.find('.designation').val()?.trim();
    let ccNumber = $lastRow.find('.cc_number').val()?.trim();
    let firstIssue = $lastRow.find('.cc_firstissue').val()?.trim();
    let validityFrom = $lastRow.find('.cc_validity_from').val()?.trim();
    let validityTo = $lastRow.find('.cc_validity_to').val()?.trim();
    ...
    // Get next row_index from existing rows
    let maxRowIndex = 0;

    $('#staff-container tr.staff-fields').each(function() {

        let rowIndex = parseInt(
            $(this).find('input[name^="row_index["]').val()
        );
    ...
    // If no row_index exists, use row count + 1
    if (maxRowIndex === 0) {
...
<tr class="staff-fields">
    ...
    <input type="hidden"
           name="row_index[${rowCount}]"
           value="${nextRowIndex}">

    <input type="hidden"
           name="staff_flag[${rowCount}]"
           value="1">
...
function removeStaffRow(button) {
    ...
    let staffId = $row.find('input[name^="staff_id["]').val() || '';
    let rowIndex = $row.find('input[name^="row_index["]').val() || '';

    // Existing database record
    if (staffId && rowIndex) {

        if ($('#deleted_staff_ids').length === 0) {

            $('#staff-container').after(`
                <input type="hidden"
                       id="deleted_staff_ids"
                       name="deleted_staff_ids"
                       value="">
            `);
        }
        ...
        let existingValue =
            $('#deleted_staff_ids').val();

        if (existingValue) {
            try {
                deletedStaff = JSON.parse(existingValue);
            } catch (e) {
                deletedStaff = [];
            }
        }
    ...
    // Add button only to last row
    $('#staff-container tr.staff-fields .btn-success')
        .remove();

    let $lastRow =
        $('#staff-container tr.staff-fields').last();
    ...
    let row_indexValue =
        $tds.eq(8).find("input[name='row_index[]']").val() || "";
    ...
    $section.attr("data-existing-age-file", age_proof);
    $section.attr("data-present-age-file", age_proof);
    ...
    let qual_proof =
        $qualTd.attr("data-educational_proof") || "";
    ...
    if (
        qualification &&
        qualification.toUpperCase() !== "8TH PASS"
    ) {
        $wrapper.show();
    } else {
        $wrapper.hide();
    ...
    $section.attr("data-existing-file", qual_proof);
    $section.attr("data-present-file", qual_proof);
    ...
    let $tdCompetency = $tds.eq(6);

    let competency =
        ($tdCompetency.attr("data-competency") || "no").toLowerCase();
    ...
    let ccVerify =
        $tdCompetency.attr("data-ccverify") || "";
    ...
    if ($firstIssue[0] && $firstIssue[0]._flatpickr) {
        $firstIssue[0]._flatpickr.setDate(
            firstIssueYMD,
            true,
            "Y-m-d"
        );
    } else {
        $firstIssue.val(firstIssueYMD);
    }


    if ($validityFrom[0] && $validityFrom[0]._flatpickr) {
        $validityFrom[0]._flatpickr.setDate(
            validityFromYMD,
            true,
            "Y-m-d"
        );
    } else {
        $validityFrom.val(validityFromYMD);
    }


    if ($validityTo[0] && $validityTo[0]._flatpickr) {
        $validityTo[0]._flatpickr.setDate(
            validityToYMD,
            true,
            "Y-m-d"
        );
    } else {
        $validityTo.val(validityToYMD);
    }


    // ================= SHOW / HIDE COMPETENCY =================
    ...
    if (ccVerify) {
        $section.attr("data-ccverify", ccVerify);
    }
 ...
 $(document).on("click", ".update-director-row", function () {
    ...
    $section
        .find("input[name='competency_certificate_holding[]']")
        .prop("checked", false);
...
$(document).ready(function(){
    ...
    let returnSections = @json($returnSections);

    console.log(returnSections);

   $(".form-section").each(function(){

        let sectionId = $(this).attr("id");

        if(!returnSections.includes(sectionId))
        {
            // readonly for normal inputs
            $(this).find("input[type=text], input[type=number], textarea")
            .prop("readonly", true);

            // disable date & file inputs
             $(this).find("select, input[type=radio], input[type=checkbox], input[type=file]")
        .css("pointer-events","none");


            // disable upload buttons
            $(this).find(".upload-btn").prop("disabled", true);

            $(this).find("#add-proprietor").prop("disabled", true);
            $(this).find(".update-proprietor-row").prop("disabled", true);
            $(this).find(".remove-proprietor-row").prop("disabled", true);


             $(this).find(".add-partner").prop("disabled", true);
            $(this).find(".update-partner-row").prop("disabled", true);
            $(this).find(".remove-partner-row").prop("disabled", true);

            $(this).find("#add-director").prop("disabled", true);
            $(this).find(".update-director-row").prop("disabled", true);
            $(this).find(".remove-director-row").prop("disabled", true);

            $(this).find("#add_qc_staff").prop("disabled", true);

            $(this).find(".remove-qc-staff").prop("disabled", true);

            $(this).find(".removeStaffRow").prop("disabled", true);

            $(this).find(".addotherstaffs").prop("disabled", true);
    ...
    <!-- ["ownership_details","staff_details"]
    <script>
        document.addEventListener("DOMContentLoaded", function() {
