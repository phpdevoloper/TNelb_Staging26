    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav id="sidebar">
            <div class="navbar-nav theme-brand flex-row  text-center">
                ...
                {{-- <li class="menu">
                    <a href="{{ route('admin.renewal_apps') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                ...
                <li class="menu">
                    <a href="{{ route('admin.mic_report') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                ...
                <li class="menu">
                    <a href="{{ route('admin.get_whcert') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg>
                                <span class="icon-name">Archived Reports</span>
                        </div>
                        {{-- <div>
                    ...
                    {{-- <ul class="collapse submenu list-unstyled" id="reports" data-bs-parent="#accordionExample">
                        <li class="active">
                            <a href="{{ route('admin.reports') }}"> W </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.get_whcert') }}"> WH </a>
                        </li>
                        <li>
                            <a href="form-layouts.html"> S </a>
                        </li>
                        <li>
                            <a href="form-validation.html"> EA </a>
                        </li>
                    </ul> --}}
                </li>
                ...
                <li class="menu">
                    <a href="{{ route('admin.payment_reports') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                ...
                <li class="menu">
                    <a href="{{ route('admin.view_applications') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                            </svg>
                            <span>Recent Applied </span>
                        </div>
                    </a>
                </li>
                @endif
                ...
                <li class="menu">
                    <a href="{{ route('admin.view_completd') }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                <polyline points="9 22 9 12 15 12 15 22"></polyline>
                ...
                {{-- <li class="menu active">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="components" data-bs-parent="#accordionExample">
                        ...
                        <li class="active">
                            <a href="staff-details.php">Add Staff</a>
                        </li>
                        <li>
                ...
                {{-- <li class="menu">
                    <a href="add-form.php" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
