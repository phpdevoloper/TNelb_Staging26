                        ...
                        <div class="widget-header applicant_details">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Applicant Id : <span> {{ $applicant->application_id }}</span> Applicant Name : <span style="color:#098501;">{{ $applicant->applicant_name }}</span> Applied For : <span style="color:#098501;"> {{ $applicant->form_name }} | License {{ $applicant->license_name }}</span> [{{$license_name->licence_name}}] </h4>
                                </div>
                            </div>
                        </div>
            ...
            function showApprovePopup(validity_override) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('admin.approveApplicationFormb') }}',
                            type: 'POST',
                            headers: {
                                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
                            },
            ...
            Swal.fire({
                ...
                html: `
                    <div class="form-check text-start">
                        <label class="form-check-label text-center" for="confirmVerification" style="color:green; font-size:18px;" >
...
//                 if (result.isConfirmed) {
//                     $.ajax({
//                         url: '{{ route('admin.returntoSupervisorformb') }}',
//                         type: 'POST',
//                         headers: {
//                             "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
//                         },
