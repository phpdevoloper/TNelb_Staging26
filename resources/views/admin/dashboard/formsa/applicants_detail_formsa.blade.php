            ...
            Swal.fire({
                ...
                html: `
                    <div class="form-check text-start">
                        <label class="form-check-label text-center" for="confirmVerification" style="font-size:19px;color:red;">
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.approveApplicationFormsa') }}',
                        type: 'POST',
                        headers: {
        ...
        confirmForwardPres.click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.forwardApplicationformsa',["role" => "__ROLE__"]) }}'.replace('__ROLE__', role),
                        type: 'POST',
                        headers: {
                            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
                        },
...
//                 if (result.isConfirmed) {
//                     $.ajax({
//                         url: '{{ route('admin.returntoSupervisorformsa') }}',
//                         type: 'POST',
//                         headers: {
//                             "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
//                         },
