            ...
            Swal.fire({
                ...
                html: `
                    <div class="form-check text-start">
                        <label class="form-check-label text-center" for="confirmVerification" style="color:red; font-size:18px;">
                            Confirm that this application has been reviewed and approved.
                        </label>
                    </div>
                `,
