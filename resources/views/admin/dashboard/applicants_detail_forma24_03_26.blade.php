                ...
                Swal.fire({
                    ...
                    html: `
                        <label style="font-size:18px;color:red;">
                            Confirm this application has been reviewed and approve.
                        </label>
                    `,
                    showCancelButton: true,
...
//         });
 ...
 forwardbtn.click(function() {
            ...
            Swal.fire({
                ...
                `,
                showCancelButton: true,
                confirmButtonText: "Forward to {{ $applicant->application_status == 'RE' || $applicant->return_flag == '1' ? 'Secretary' : 'Accountant' }}",
                cancelButtonText: "Cancel",
                focusConfirm: false,
            }).then((result) => {
                if (result.isConfirmed) {
