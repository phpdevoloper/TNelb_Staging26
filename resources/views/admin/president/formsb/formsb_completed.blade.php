                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('admin.applicants_detail_formsb_completed', ['applicant_id' => $application->application_id]) }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        {{ '-' }}
                                                                        @else
                                                                            <a class="badge badge-primary mb-2 me-4" href="{{ route('admin.generateFormsb.pdf', ['application_id' => $application->application_id]) }}" target="_blank">
