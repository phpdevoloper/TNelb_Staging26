            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="seperator-header layout-top-spacing">
                        <h4 class="">Completed Applications For A (License EA )</h4>
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('admin.applicants_detail_forma_completed', ['applicant_id' => $application->application_id]) }}">
                                                                ...
                                                                {{ $license->license_number ?? '' }}
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        {{ '-' }}
                                                                        @else
                                                                            <a class="badge badge-primary mb-2 me-4" href="{{ route('admin.generateForma.pdf', ['application_id' => $application->application_id]) }}" target="_blank">
