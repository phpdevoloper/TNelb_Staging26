...
<style>
    ...
    table th {
        background-color: #332ec7!important;
        color: #222 !important;
        text-align: center;
        font-weight: bold;
        padding: 12px;
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="seperator-header layout-top-spacing">
                        <h4 class="">Completed Applications For {{ $workflows->first()->form_name }} (License {{ $workflows->first()->license_name }} )</h4>
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('admin.applicants_detail_formsa_completed', ['applicant_id' => $application->application_id]) }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        {{ '-' }}
                                                                        @else
                                                                            <a class="badge badge-primary mb-2 me-4" href="{{ route('admin.generateFormsa.pdf', ['application_id' => $application->application_id]) }}" target="_blank">
                                                                     ...
                                                                     <td>
                                                                        ...
                                                                        {{ '-' }}
                                                                        @else
                                                                            <a class="badge badge-info mb-2 me-4" href="{{ route('admin.generateForma_download.pdf', ['application_id' => $application->application_id]) }}" target="_blank">
                                                                                 Download Licence
                                                                            </a>
                                                                        @endif
                                                                    </td>
