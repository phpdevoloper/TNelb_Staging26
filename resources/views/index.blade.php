...
<section class="banner-section mt-0">
    ...
    <div class="stop-slider-container">
        <button class="stop-sliders theme-btn btn-style-two"><i class="fa fa-pause"></i></button>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    @foreach($licence_details as $licence)
                    @if($licence->category_id == '2')
                    ...
                    $colorClass = $formColors[$licence->cert_licence_code] ?? 'bg-default';
                    @endphp
                    ...
                    <div class="col-md-6 service-block">
                        <div class="inner-box">
                            ...
                            <div class="content">
                                <h4>{{ $licence->licence_name }}</h4>
                                <div class="text">
                                    Form "{{ $licence->form_code }}" <br>
                                    LICENSE `{{ $licence->cert_licence_code }}'
                                </div>
...
<section class="services-section-three" style="background-image: url(assets/images/bg/project-counter.jpg);">
    <div class="auto-container">
        <div class="row ">
            ...
            <div class="col-xl-8">
                <div class="row ">
                    <div class="sec-title text-center m-auto mb-10">
                    <h2 class="text-white">Issued Licence/Certificate History</h2>
                </div>
                ...
                <div class="row">
                     <div class="col-md-6">
                            <div class="row align-items-center text-center">
                                ...
                                <div id="chart_div_competency" style="width:100%; "></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="row align-items-center text-center">
                                ...
                                <div id="chart_div_contractor" style="width:100%; "></div>
                            </div>
                        </div>
                    ...
                    <script>
                        ...
                        function drawCompetencyChart() {
                          ...
                          var rows = @json(
                                $licence_details
                                    ->where('category_id', '2')
                                    ->map(function($licence) use ($counts) {

                                        $formCode = strtoupper($licence->form_code);
                          ...
                          var options = getCommonOptions('Competency Certificate');

                            var chart = new google.visualization.PieChart(
                                document.getElementById('chart_div_competency')
                            );
                        ...
                        function drawContractorChart() {
                           ...
                           var rows = @json(
                            ...
                            data.addRows(rows);
                             ...
                             var options = getCommonOptions('Contractor Licence');

                            var chart = new google.visualization.PieChart(
                                document.getElementById('chart_div_contractor')
                            );
...
<section class="services-section-three" style="background-image: url(assets/images/bg/project-counter.jpg);display:none;">
    <div class="auto-container">
        <div class="row align-items-center">
