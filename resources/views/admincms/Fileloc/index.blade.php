...
<!--Add Module Modal -->
<div class="modal fade" id="addmoduleFormModal" tabindex="-1" role="dialog" aria-labelledby="addmoduleFormModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addFormModalLabel"><span class="badge badge-primary"><i class="fa fa-wpforms"></i></span> Add Form Module </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form id="addformmodule" class="simple-example" novalidate>
                <div class="modal-body">
                    <!-- <div class="row">
                        <div class="col-lg-12 mb-3">
                            <label for="inputEmail4" class="form-label">Choose Licence Name<span class="text-danger">*</span> </label>
                            <select class="form-select" name="cert_license_id" id="form_cate">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-2">
                            <label for="inputEmail4" class="form-label">Add Form Module Name <span class="text-danger">*</span> </label>
...
<div class="modal fade" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addFormModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addFormModalLabel"><span class="badge badge-primary"><i class="fa fa-wpforms"></i></span> Add File Path</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="red" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle">
                            <circle cx="12" cy="12" r="10"></circle>
            ...
            <form id="addfilepath" class="simple-example" novalidate>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <label for="inputEmail4" class="form-label">Choose Licence Name<span class="text-danger">*</span> </label>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-2">
                            <label for="inputEmail4" class="form-label">Temporary Filepath <span class="text-danger">*</span> </label>
                            <input type="text" class="form-control" name="filepath_temp" id="filepath_temp">

                            <!-- <textarea class="form-control" rows="2" name ="equip_name"></textarea> -->
                            <small class="text-danger d-none error-filepath_temp">Fill Temporary Filepath</small>
                        </div>
