...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="middle-content p-0">
            <div class="page-meta">
                <h4>Master Checklist Management Console</h4>
                            ...
                            <div class="card">
                                ...
                                <table id="style-3" class="table style-2  dt-table-hover table-records">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($checklist_data as $index => $row)
                                        <!-- {{ $index }} -->
                                        <tr>
                                            <!-- S.No -->
                                            ...
                                            <td>
                                                @if($row->appl_type == 'N')
                                                New
                                                @elseif($row->appl_type == 'R')
                                                Renewal
                                                @elseif($row->appl_type == 'D')
                                                Digitization
                                                @else
                                                Alteration
                                                @endif
...
<div class="modal fade" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addFormModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addFormModalLabel"><span class="badge badge-primary"><i class="fa fa-wpforms"></i></span> Add Checklist</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form id="addchecklist" class="simple-example" novalidate>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <select class="form-select" name="appl_type" id="appl_type">
                                ...
                                <option value="D">Digitization Applications</option>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-2">
                            <label for="inputEmail4" class="form-label">Checklist Name <span class="text-danger">*</span> </label>
                            ...
                            <small class="text-danger d-none error-checklist_name">Fill CheckList Name</small>
                        </div>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <button type="button" class="btn btn btn-light-dark" data-bs-dismiss="modal" onclick="$('#addchecklist').trigger('reset');"><i class="flaticon-cancel-12"></i> Cancel</button>
                        </div>
                    </div>
                </div>
            </form>
